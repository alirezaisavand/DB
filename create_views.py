...
cur.execute("CREATE VIEW Resfood[(id,name,type,amount,description,price,restaurantId)] AS SELECT id, name, type, amount, description, price, restaurantId from food")
